...
def combat():
    ...
    while character_health_total > 0:
        ...
        if MainClasses.chosen_class.stun_capable_attack:
            ...
            if MainClasses.chosen_class.stun_chance > Enemies.random_enemy.stun_resist and random.randint(0,
                                                                                                          100) > Enemies.random_enemy.stun_resist - MainClasses.chosen_class.stun_chance:
